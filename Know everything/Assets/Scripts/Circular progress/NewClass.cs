...
namespace Sample
{
    ...
    public class SpriteDemo : StatefulWidget
    {
        public SpriteDemo(Key key=null) : base(key)
        {
        }

        public override State createState()
        {
            return new SpriteDemoState();
        }
    }
    public class SpriteDemoState : SingleTickerProviderStateMixin<SpriteDemo>
    {
        Animation<float> animation;
